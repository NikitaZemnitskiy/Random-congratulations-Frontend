...
!function (e) {
  ...
  angular.module("pw.canvas-painter", []), function (e) {
    ...
    return {
      restrict: "AE",
      scope: {options: "=", version: "="},
      templateUrl: "../templates/canvas.html",
      link: function (t, n) {
        var o = !!("ontouchstart" in e), a = o ? "touchstart" : "mousedown", i = o ? "touchmove" : "mousemove",
          r = o ? "touchend" : "mouseup", c = t.options;
        ...
        var p = s.getContext("2d"), v = d.getContext("2d"), h = {x: 0, y: 0}, f = [];
        ...
        var m = function (e) {
          ...
          for (var n = 1; n < f.length - 2; n++) {
            var o = (f[n].x + f[n + 1].x) / 2, a = (f[n].y + f[n + 1].y) / 2;
          ...
          e.preventDefault(), d.addEventListener(i, y, !1), g(h, e), f.push({x: h.x, y: h.y}), f.push({
            x: h.x,
            y: h.y
          }), y()
        }, x = function () {
